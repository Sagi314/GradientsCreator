package com.sbmgames.gradientscreator.customviews.gradientdrawablepicker;
...
import com.sbmgames.gradientscreator.customviews.addons.itemsdecorations.MarginForAllExceptLastDecoration;
import com.sbmgames.gradientscreator.customviews.addons.itemtouchhelpers.ChangeItemPositionOnDrag;
import com.sbmgames.gradientscreator.customviews.addons.itemtouchhelpers.DeleteOnSwipe;
import com.sbmgames.gradientscreator.customviews.colorpickerdialog.ColorPickerDialog;
import com.sbmgames.gradientscreator.customviews.colorslistadapter.ColorsListAdapter;
import com.sbmgames.gradientscreator.customviews.popups.spinners.sbmspinner.SbmSpinner;
import com.sbmgames.gradientscreator.customviews.popups.seekbarpopup.SeekBarPopup;
import com.sbmgames.gradientscreator.models.ColorsList;
...
public class GradientDrawablePicker extends FrameLayout
{
    ...
    private class GradientRadiusPopupViewHandler
    {
        ...
        public void setGradientMaxRadius(float maxRadius)
        {
            if (maxRadius < 0)
            {
                throw new IllegalArgumentException("radiusPercentSize must be >= 0");
            }
        ...
        public void setGradientRadiusPercent(int percent)
        {
            ObjectsVerifiers.requireInRange(0, 101, percent);
