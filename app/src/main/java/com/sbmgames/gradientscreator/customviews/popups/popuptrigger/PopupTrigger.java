package com.sbmgames.gradientscreator.customviews.popups.popuptrigger;
...
import com.sbmgames.gradientscreator.customviews.movablepopupwindow.MovablePopupWindow;
...
public abstract class PopupTrigger extends View
{
    ...
    {
        var allowedPopupViewType = Objects.requireNonNull(getAllowedPopupViewType());
        if (!allowedPopupViewType.isInstance(popupView))
        {
            throw new IllegalArgumentException("'popupView' must be instance of " + allowedPopupViewType.getName());
        }
