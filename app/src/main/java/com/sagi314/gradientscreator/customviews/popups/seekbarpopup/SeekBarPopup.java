package com.sagi314.gradientscreator.customviews.popups.seekbarpopup;
...
public class SeekBarPopup extends PopupTrigger
{
    ...
    {
        Validators.requireAbove(textSize, 0, "'textSize' must be > 0");
    ...
    {
        this.textPrefix = Validators.ifNullGet(textPrefix, "");
    }

    public void setTextSuffix(String textSuffix)
    {
        this.textSuffix = Validators.ifNullGet(textSuffix, "");
    }

    public void addOnProgressChangedListener(OnProgressChangedListener onProgressChangedListener)
    {
        Validators.requireNotNull(onProgressChangedListener, "can't add a null listener");
    ...
    {
        Validators.requireNotNull(onProgressChangedListener, "can't remove a null listener");
